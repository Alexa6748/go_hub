...
var (
	...
	URL string
	client *http.Client
	arp_table map[int]interface{} = make(map[int]interface{})
...
func main() {
	...
	CalculateTable_CRC8()   // Таблица вычисления контрольных сумм
	client = &http.Client{} // Создаем клиент для запросов
